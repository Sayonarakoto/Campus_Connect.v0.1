...
export const allocateHouses = (rebalance = false) => axios.post(`${API_URL}/api/sports-houses/allocate`, { rebalance }, { headers: auth() });
...
// Masters
export const listMasters = (academicYear) => axios.get(`${API_URL}/api/sports-masters`, { headers: auth(), params: { academicYear } });
