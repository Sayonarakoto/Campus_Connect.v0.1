...
router.get("/stats", auth, role("admin", "faculty", "tutor", "hod", "student", "sports committee", "sports-committee", "sportscommittee"), c.allocationStats);
router.get("/template", auth, role("admin", "faculty", "sports committee", "sports-committee", "sportscommittee"), c.bulkTemplate);
router.get("/export", auth, role("admin", "faculty", "tutor", "hod", "student", "sports committee", "sports-committee", "sportscommittee"), c.exportAssignments);
router.post("/", auth, role("admin", "faculty", "sports committee", "sports-committee", "sportscommittee"), c.createHouse);
router.post("/bulk-assign", auth, role("admin", "faculty", "sports committee", "sports-committee", "sportscommittee"), c.bulkAssignHouses);
